export function KeeperHubLogo({ className }: { className?: string }) {
  return (
    <svg
      aria-label="KeeperHub Logo"
      className={className}
      fill="none"
      height="24"
      viewBox="0 0 318 500"
    ...
    >
      <title>KeeperHub Logo</title>
      <path d="M317.77 204.279H226.98V295.069H317.77V204.279Z" fill="#00FF4F" />
      <path

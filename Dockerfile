...
ARG NEXT_PUBLIC_CREDITS_CONTRACT_ADDRESS
ARG NEXT_PUBLIC_TIERS_CONTRACT_ADDRESS
ARG NEXT_PUBLIC_CHAIN_ID
ENV NEXT_PUBLIC_CREDITS_CONTRACT_ADDRESS=$NEXT_PUBLIC_CREDITS_CONTRACT_ADDRESS
ENV NEXT_PUBLIC_TIERS_CONTRACT_ADDRESS=$NEXT_PUBLIC_TIERS_CONTRACT_ADDRESS

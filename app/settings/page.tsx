...
export default function SettingsPage() {
  ...
  const [newSourceConnectionString, setNewSourceConnectionString] = useState('');
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="sourceType" value="PostgreSQL" disabled className="bg-muted" />
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => setNewSourceConnectionString(e.target.value)}
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="sourceIsDefault" className="cursor-pointer font-normal">
                      Set as default data source
                    </Label>
                  </div>

                  <div className="flex gap-4 pt-4">
                    <Button onClick={addDataSource} disabled={savingSource}>
